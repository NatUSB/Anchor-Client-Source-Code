...
import com.anchorclient.client.ui.MainMenu;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        LoadingScreen.drawScreen(getTextureManager());
        ...
        LoadingScreen.setStatus(1, "RenderEngine");
        this.renderEngine.loadTickableTexture(TextureMap.locationBlocksTexture, this.textureMapBlocks);
        this.renderEngine.bindTexture(TextureMap.locationBlocksTexture);
        this.textureMapBlocks.setBlurMipmapDirect(false, this.gameSettings.mipmapLevels > 0);
        LoadingScreen.setStatus(2, "ModelManager");
        ...
        LoadingScreen.setStatus(3, "EntityRenderer");
        this.entityRenderer = new EntityRenderer(this, this.mcResourceManager);
        this.mcResourceManager.registerReloadListener(this.entityRenderer);
        this.blockRenderDispatcher = new BlockRendererDispatcher(this.modelManager.getBlockModelShapes(), this.gameSettings);
        this.mcResourceManager.registerReloadListener(this.blockRenderDispatcher);
        LoadingScreen.setStatus(4, "RenderGlobal");
        ...
        LoadingScreen.setStatus(5, "Anchor Main");
        AnchorClient.INSTANCE.initializeMain();

        LoadingScreen.setStatus(6, "Font Manager");
        AnchorClient.INSTANCE.initializeFont();

        LoadingScreen.setStatus(7, "Module Manager");
        AnchorClient.INSTANCE.initializeModules();

        LoadingScreen.setStatus(8, "Cosmetic Manager");
        AnchorClient.INSTANCE.initializeCosmetics();

        LoadingScreen.setStatus(9, "Discord Rich Presence: OFF");
        AnchorClient.INSTANCE.initializeDiscordRPC();

        LoadingScreen.setStatus(10, "Servers");
        AnchorClient.INSTANCE.initializeServers();

        LoadingScreen.setStatus(11, "Account Manager");
        AnchorClient.INSTANCE.initializeAccountManager();

        LoadingScreen.setStatus(12, "Finalizing");
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle("Anchor Client Is Loading... ");
    ...
    public void launchIntegratedServer(String folderName, String worldName, WorldSettings worldSettingsIn)
    {
        ...
        //AnchorClient.INSTANCE.discordRP.updatePresence("In-Game", "Singleplayer");
    }
