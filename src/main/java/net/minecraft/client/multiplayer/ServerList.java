...
public class ServerList
{
    ...
    private void loadPartneredServers() {
        for(Server s : AnchorClient.INSTANCE.serverManager.getServersByType(ServerType.PARTNER)) {
            this.addServerData(s);
        }
    }

    private void loadFeaturedServers() {
        for(Server s : AnchorClient.INSTANCE.serverManager.getServersByType(ServerType.FEATURED)) {
            this.addServerData(s);
        }
    }
    ...
    public void saveServerList()
    {
        try
        {
            ...
            {
                if(!(serverdata instanceof Server)) {
