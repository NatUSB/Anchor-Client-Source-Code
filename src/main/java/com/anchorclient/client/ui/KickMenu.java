...
public class KickMenu extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        AnchorClient.INSTANCE.fontManager.getFont("anchor 26").drawCenteredString("You have been kicked from Anchor Client!", sr.getScaledWidth()/2f, sr.getScaledHeight()/2f, -1);
        AnchorClient.INSTANCE.fontManager.getFont("anchor 22").drawCenteredString("Reason: " + reason, sr.getScaledWidth()/2f, sr.getScaledHeight()/2f + 20, -1);
    }
