package com.anchorclient.client.util.render.animation;
...
public class Animation {
	...
	/**
	 * Instead of constructing the animation with a specific duration construct it
	 * with a specific amount to change in a second
	 *
	...
	/**
	 * Whether the value is constantly decreasing or increasing
	 */
	boolean increasing;
	...
	public String toString() {
		return "Animation{" +
				...
				", start=" + start +
				", end=" + end +
				", increasing=" + increasing + ", easing=" + easing + ", done=" + isDone() + " " + '}';
	}
